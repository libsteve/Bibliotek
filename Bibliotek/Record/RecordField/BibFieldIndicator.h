...
/// - note: This method will throw an out-of-bounds exception for invalid indicator characters.
...
/// ```
///
/// - parameter rawValue: The ASCII space, lowercase letter, or number.
/// - returns: An indicator object with some semantic metadata meaning about a data field.
...
///
/// - parameter indicator: The record field with which the receiver should be compared.
/// - returns: Returns `YES` if the given indicator and the receiver have the same raw value.
