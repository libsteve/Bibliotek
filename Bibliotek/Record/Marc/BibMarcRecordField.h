...
@property (nonatomic, readonly, strong) _BibMarcRecordFieldTag fieldTag NS_SWIFT_NAME(tag);
...
- (instancetype)initWithFieldTag:(_BibMarcRecordFieldTag)fieldTag firstIndicator:(BibMarcRecordFieldIndicator)firstIndicator secondIndicator:(BibMarcRecordFieldIndicator)secondIndicator subfields:(NSDictionary<NSString *, NSString *> *)subfields NS_DESIGNATED_INITIALIZER NS_SWIFT_NAME(init(tag:first:second:subfields:));
