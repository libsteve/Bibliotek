...
/// - parameter string: A string of characters to represent using an alternate encoding
///                     scheme.
/// - returns: The converted string value of the original string. This value must be freed
///            by the caller. `NULL` is returned when there is an error converting the
///            given string.
/// - postcondition: Call `yaz_iconv_error()` to get the error code when `NULL` is
///                  returned.
